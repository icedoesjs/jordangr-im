    ...
    <div>
      ...
      <div className="about-container" id="about">
        <div className="about-content">
          ...
          <p className="about-text">I have been working since I was 14 doing many different things. My parents are both entrepreneurs and I have always helped in both family businesses, as well as my grandpas. I picked up software development in my free time, starting with Javascript making Discord bots and CLI tools. I became a freelance developer when I was 15 and learned an incredible amount. My time spent freelancing taught me invaluable knowledge which I carry to this day. I picked up C# when I was almost 16 for a game called FiveM and continued into the game's framework when I learned LUA. My journey has came with many lessons and made my fondness for software and computers in a whole deeper than I ever could have imagined. I can proudly say I am addicted to learning and bettering my code and myself.</p>
        </div>
      </div>
