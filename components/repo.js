...
const { github_name, repo_data, use_previews } = require('../config');
...
export default function Repo({ name }) {
    ...
    if (name.includes("|")) {
        ...
        return (
            ...
            {use_previews && <Image src={repo_data[repo_name].image} className="project-image" width={500} height={200} alt="Preview of this repo"/> }
